...
@RequestScoped
public class AuthorizedHandlerMatcher extends AbstractMatcher<Method> {
	
	@Override
	public boolean matches(Method method) {
		AuthorizationPolicy authorizationPolicy = method.getDeclaringClass().getAnnotation(AuthorizationPolicy.class);
		return authorizationPolicy != null && authorizationPolicy.value() == Policy.AUTHORIZED;
	}
}