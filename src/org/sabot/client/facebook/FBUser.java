 ...
 */
public class FBUser extends JavaScriptObject {
	...
	public final native String getUsername() /*-{ return this.ame; }-*/;
	...
	public final RemoteUser asRemoteUser() {
		return new RemoteUser(getFirstName(), getLastName(), getEmail(), getId(), OauthProvider.FACEBOOK);
	}
}
